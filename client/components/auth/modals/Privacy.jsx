...
let debug = Debug('Privacy');
//debug.enabled = window.debug;

export class Privacy extends Component {
	render () {
		debug('render, called.');
		return <div className="modal fade" id="privacy-modal" tabIndex="-1" role="dialog" aria-labelledby="privacy-title" aria-hidden="true">
			<div className="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
		  		<div className="modal-content">
		      		<div className="modal-header">
		        		<h5 className="modal-title" id="privacy-title">Privacy</h5>
