...
let debug = Debug('Cookies');
//debug.enabled = window.debug;

export class Cookies extends Component {
	render () {
		debug('render, called.');
		return <div className="modal fade" id="cookies-modal" tabIndex="-1" role="dialog" aria-labelledby="cookie-title" aria-hidden="true">
			<div className="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
		  		<div className="modal-content">
		      		<div className="modal-header">
		        		<h5 className="modal-title" id="cookie-title">Cookies</h5>
